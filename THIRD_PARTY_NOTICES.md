...
- Purpose: the deer icon used in Workdoe's logo, six service-family icons,
  the task-level icons used by the guided project picker, the project-review
  pencil icon, and the dialog close icon.
- License: MIT.
...
| Tabler `pencil.svg` | `03a842bd4a16861b0adc0e38ed7b0eb5e7cc613012006833da22e58d56f1f1fe` |
